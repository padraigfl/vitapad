...
struct VitaPadSettings SETTINGS = {DEFAULT_ACTIVE_DISPLAY, DEFAULT_BUTTON_MAPPING, DEFAULT_BUTTON_ORDER};
struct VitaPadSettings DEFAULT_SETTINGS = {DEFAULT_ACTIVE_DISPLAY, DEFAULT_BUTTON_MAPPING, DEFAULT_BUTTON_ORDER};
...
static SettingEntry SettingEntries[] = {
        ...
        {"BUTTON_MAPPING", (int *)&SETTINGS.BUTTON_MAPPING},
};
...
void toggleAltLayout() {
    SETTINGS.BUTTON_MAPPING = ((++SETTINGS.BUTTON_MAPPING) % 3);
}

void toggleAB() {
    SETTINGS.BUTTON_ORDER = ((++SETTINGS.BUTTON_ORDER) % 2);
}
